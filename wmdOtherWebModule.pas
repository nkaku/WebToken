...
type
  TwmdWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TwmdWebModule;
...
procedure TwmdWebModule.WebModuleCreate(Sender: TObject);
begin
...
procedure TwmdWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
